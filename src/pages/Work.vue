		...
		<div class="w-full md:w-3/4 lg:w-1/2">
			...
			<div class="mb-12">
				...
				<p class="text-base md:text-lg text-gray-700 mb-6">
					Explore some of my professional work and side projects. Click the link
			...
			<div>
				...
				<p class="text-base md:text-lg text-gray-700 mb-6">
					Discover my handmade crafts and digital creations. Click below to explore
					my Etsy shop and Pinterest inspirations.
				</p>
				<a
					href="/etsy"
					class="inline-block bg-pink-500 text-white py-2 px-4 rounded-lg hover:bg-pink-600">
					Visit Etsy & Pinterest
				</a>
			</div>
		</div>
	</div>
