<template>
  <div class="animate-slide-in">
    <div class="flex items-center justify-center p-4 pt-20 pb-20 md-pad:p-20">
      <div
        class="container grid gap-8 grid-cols-1 grid-rows-10 max-w-6xl lg:grid-cols-2 lg:grid-rows-3"
      >
        <div
          class="flex bg-white p-4 rounded-md shadow-2xl text-center row-span-2 lg:row-span-1 animate-slide-in-delayed"
        >
          <div class="p-10 animate-slide-in-delayed">
            <AboutGetToKnowMe />
          </div>
        </div>
        <div
          class="flex bg-white p-4 rounded-md shadow-2xl text-center row-span-2 lg:row-span-1 animate-slide-in-delayed"
        >
          <div class="flex-1 p-10 animate-slide-in-delayed">
            <AboutCoreValues />
          </div>
        </div>
        <div
          class="flex bg-white items-center pt-20 p-4 rounded-md shadow-2xl row-span-3 lg:col-span-2 lg:row-span-1 lg:pt-0 animate-slide-in-delayed"
        >
          <div class="flex-1 p-10 animate-slide-in-delayed">
            <AboutTimeline />
          </div>
        ...
        <div
          class="flex bg-white p-4 rounded-md shadow-2xl row-span-3 lg:col-span-2 lg:row-span-1 animate-slide-in-delayed"
        >
          <div class="flex-1 p-10 animate-slide-in-delayed">
            <TabGroup>
              <TabList
                class="space-x-0 rounded-md bg-cool-green p-1 sm:flex sm:space-x-1"
              >
                <Tab as="template" v-slot="{ selected }">
                  <button
                    :class="[
                      ...
                      selected
                        ? 'bg-cool-green-dark shadow'
                        : 'text-creamy-beige hover:bg-white/[0.12] hover:text-white',
                    ]"
                  >
                    Languages
                  </button>
              ...
              <TabPanels>
                <TabPanel>
                  <div
                    class="grid grid-cols-3 grid-rows-2 items-center justify-center gap-7 pt-10 md:grid-cols-5 md:grid-rows-2"
                  >
                    <div class="mx-auto">
